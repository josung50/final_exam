...
public class DB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE list (id INTEGER PRIMARY KEY AUTOINCREMENT , name TEXT , age TEXT , salary INTEGER);";
        db.execSQL(sql);
    }
    ...
    public void insert(String name , String age , int salary) {
        ...
        String sql = "INSERT INTO list values(null,'" + name +"','" + age +"','" + salary +"');";
        db.execSQL(sql);
    }
